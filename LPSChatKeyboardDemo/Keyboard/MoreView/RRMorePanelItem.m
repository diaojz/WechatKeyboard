...
- (void)setImageName:(NSString *)imageName
{
    ...
    [self.button setImage:[UIImage imageWithBundleName:imageName] forState:UIControlStateNormal];
}
#pragma mark - Getter
