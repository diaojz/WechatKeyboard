...
//#import "RRToastView.h"

#pragma clang diagnostic ignored "-Wdeprecated"

NSString *const kXMNAudioDataKey;

@interface RRAudioPlayer ()<AVAudioPlayerDelegate>
...
@property (nonatomic, copy) void(^finishPlayingHandler)();
...
- (void)playAudioWithURLString:(NSString *)URLString complete:(void (^)())complete {
    if (!URLString.length) {
        return;
    }
...
- (void)stopAudioPlayer {
    if (_audioPlayer) {
        ...
        _complete = nil;
        [[RRAudioPlayer sharePlayer] setAudioPlayerState:RRAudioPlayerStateCancel];
        [self handleMonitorNotification:NO];
    }
}

- (void)didFinishPlayingHandler:(void(^)())finishPlayingHandler {
